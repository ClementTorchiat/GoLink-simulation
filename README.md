# GoLink Simulation - Réseau de Transport Modulaire
...
* **Vue Thermique (Heatmap) :** Une surcouche visuelle (style rayons X) permet de visualiser les zones de forte demande (hotspots) et la densité du trafic.
